        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-4">
                    <br><br>
                <div class="banner">
                    <img src="./img/Banho.jpg" alt="banner" class="bannerserv">
                </div>
            </div>
            
                <div class="col-md-8">
                    <div class="title">
                        <h2 class="Title-About">Banho para Porte Médio</h2>
                    </div>
                    <br><br>
                    <div class ="box">
                    ...
                    <p class="text">
                        ...
                        <br><br>
                        Existem procedimentos corretos para que o banho seja bem realizado e o pet fique realmente limpo e higienizado.
                    </p>
                </div>
            </div>
