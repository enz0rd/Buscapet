        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-md-4">
                    <br><br><br>
                <div class="banner">
                    <img src="./img/remédio.jpg" alt="banner" class="bannerserv">
                </div>
            </div>
            
                <div class="col-md-8">
                    <div class="title">
                        <h2 class="Title-About">Antitóxico</h2>
                    </div>
                    <br><br>
                    <div class ="box">
                        ...
                        <div class="prices">
                        <p class="item-price"><b>R$34,99</b></p>
                        </div>
                        <br><br>
                    <p class="text">
                        
                        É indicado para animais como hepatoprotetor nas intoxicações medicamentosas, por plantas tóxicas, por ingestão de alimentos contaminados ou de produtos químicos tóxicos.
                        <br><br>
                        Auxilia também no tratamento das afecções hepáticas causadas por doenças infecciosas. Possui ação lipotrópica nas infiltrações gordurosas do fígado.
                    </p>
                </div>
            </div>
