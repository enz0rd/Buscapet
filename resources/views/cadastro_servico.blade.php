...
<div class="content">
    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-md-12">
                <div class="title">
                    <h2 class="Title-services">Adicionar Serviço</h2>
                </div>
                <br><br>
                    <div class="row g-5">
                        <div class="col-md-12 col-lg-12">
                            <form class="needs-validation" novalidate method="POST" action="../processos/cadastro_servico.php" enctype="multipart/form-data">
                                <div class="row g-3">
                                <div class="col-12">
                                    <label for="firstName" class="form-label">Nome</label>
                                    <input type="text" class="form-control" id="ds_servico" maxlength="50" placeholder="Nome do serviço" name="nome_servico" required>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="float" class="form-control" name="valor_servico" id="valor_servico" placeholder="50.50" maxlength="11" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="desc_servico" class="form-control" id="desc" placeholder="Descrição do seu serviço" maxlength="100" required>
                                    <div class="invalid-feedback">
                                    Preencha o campo
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="file" accept="image/png, image/jpeg" name="img_servico" class="form-control" required>
                                    <div class="invalid-feedback">
