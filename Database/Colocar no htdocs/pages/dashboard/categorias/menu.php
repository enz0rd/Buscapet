          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
              <?php
                ...
                $selecttype = "SELECT idcategoria, ds_categoria FROM categorias_empresas";
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
              <?php
                include_once('../../../conecta.php');
                $selecttype = "SELECT idcategoria, ds_categoria FROM categorias_prodser";
                $result_type = mysqli_query($conexao, $selecttype);
                while ($tipo = mysqli_fetch_array($result_type)) {
              ?>
                <tr>   
