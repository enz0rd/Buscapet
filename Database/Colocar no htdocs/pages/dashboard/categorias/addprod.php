  ...
  <div class="row">
    ...
    <main>
      <div class="py-5 text-center">
        ...
        <h2>Adicionar Categoria de Produto/Serviço</h2>
      </div>

        <div class="col-md-8 col-lg-4">
          <form class="needs-validation center" novalidate method="POST" action="./src/catprod.php" enctype="multipart/form-data">
            <div class="row g-3">
              <div class="col-12">
