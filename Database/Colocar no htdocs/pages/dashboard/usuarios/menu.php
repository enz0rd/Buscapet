        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php
              ...
              $selecttype = "SELECT idusuarios, ds_usuario, ds_email, ds_senha FROM usuarios";
              $result_type = mysqli_query($conexao, $selecttype);
              while ($tipo = mysqli_fetch_array($result_type)) {
            ?>
               <tr>   
                <td><?php echo $tipo['idusuarios'] ?></td>
                <td><?php echo $tipo['ds_usuario'] ?></td>
                <td><?php echo $tipo['ds_email'] ?></td>
                <td><?php echo $tipo['ds_senha'] ?></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
