...
<html lang="en">
  <head>
    ...
    <title>Dashboard Buscapet - Categorias</title>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../usuarios/menu.php">
    ...
    <main>
      <div class="py-5 text-center">
        ...
        <div class="col-md-8 col-lg-12">
          <form class="needs-validation" novalidate method="POST" action="./src/usuario.php" enctype="multipart/form-data">
            <div class="row g-3">
              <div class="col-4">
                <label for="firstName" class="form-label">Usuário</label>
                <input type="text" class="form-control" id="ds_usuario" maxlength="50" placeholder="Usuário" name="ds_usuario" required>
              ...
              <div class="col-4">
                ...
                <input type="float" class="form-control" name="ds_email" id="ds_email" placeholder="example@mail.com" maxlength="40" minlength="6" required>
                <div class="invalid-feedback">
              ...
              <div class="col-4">
                ...
                <input type="password" name="ds_senha" class="form-control" id="ds_senha" placeholder="*********" maxlength="100" minlength="3" required>
                <div class="invalid-feedback">
                  Preencha a senha
                </div>
              </div>
                <input class="w-20 btn btn-primary btn-lg" type="submit" value="Cadastrar Usuário" />
          </form>
        </div>
      </div>
    </main>
