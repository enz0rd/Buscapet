...
$cadastro = mysqli_query($conexao, $result_empresa);
$ultimo_id = mysqli_insert_id($conexao);
echo "Último id inserido: $ultimo_id <br>";

//pasta que salva as imagens

$_UP['pasta'] = '../imagens/' . $empresa . '/';
$_UP['pasta_produtos'] = '../../produtos/imagens/produtos/' . $ultimo_id . '/';
$_UP['pasta_servicos'] = '../../serviços/imagens/serviços/' . $ultimo_id . '/';
