    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../serviços/menu.php">
    ...
    <main>
      ...
      <div class="row g-5">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div class="wrap">
                ...
                <small class="text-muted name wrap" id="output_name">Nome do Serviço</small>
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                <h6 class="my-0">Categoria:</h6>
                <small class="text-muted" id="output_type">Categoria do Serviço</small>
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
            ...
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                ...
                <small class="text-muted" id="output_val">0.00</small>
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div class="wrap">
                <h6 class="my-0">Descrição:</h6>
                <small class="text-muted desc wrap" id="output_desc">Descrição do Serviço</small>
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
        ...
        <div class="col-md-7 col-lg-8">
          <h4 class="mb-3">Adicionar Serviço</h4>
          <form class="needs-validation" novalidate method="POST" action="./src/servicos.php" enctype="multipart/form-data">
            <div class="row g-3">
              <div class="col-12">
                <label for="firstName" class="form-label">Nome</label>
                <input type="text" oninput="loadname()" class="form-control" id="ds_servico" maxlength="50" placeholder="Nome do serviço" name="ds_servico" required>
              ...
              <div class="col-4">
                ...
                <input type="float" oninput="loadval()" class="form-control" name="valor_servico" id="valor_servico" placeholder="50.50" maxlength="11" required>
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                ...
                <input type="text" oninput="loaddesc()" name="desc" class="form-control" id="desc" placeholder="Descrição do seu serviço" maxlength="100" required>
                <div class="invalid-feedback">
                  Preencha o campo
                </div>
              </div>
              ...
              <div class="col-12">
                <label for="img_servico" class="form-label">Imagem</label>
                <input type="file" accept="image/png, image/jpeg" name="img_servico" onchange="loadlogo(event)" class="form-control" required>
                <div class="invalid-feedback">
                  Insira uma imagem válida
                </div>
              </div>

              <input class="w-100 btn btn-primary btn-lg" type="submit" value="Cadastrar Serviço" />
          </form>
        </div>
      </div>
    </main>
...
<script>
  ...
  var loadname = function(event) {
    var name = document.getElementById('ds_servico').value;
  ...
  var loademp = function(event) {
    var type = document.getElementById('empresa').value;
    document.getElementById('output_emp').innerHTML = type;
  };
  var loaddesc = function(event) {
    var desc = document.getElementById('desc').value;
    document.getElementById('output_desc').innerHTML = desc;
  };
  var loadval = function(event) {
    var desc = document.getElementById('valor_servico').value;
    document.getElementById('output_val').innerHTML = desc;
  };
</script>
    </main>
  </div>
