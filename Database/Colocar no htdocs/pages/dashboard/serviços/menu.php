        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php
              ...
              $selecttype = "SELECT idservico, ds_servico, valor_servico, desc_servico, ds_categoria, ds_empresa FROM servicos,empresas,categorias_prodser WHERE servicos.idcategoria = categorias_prodser.idcategoria AND servicos.idempresa = empresas.idempresa";
