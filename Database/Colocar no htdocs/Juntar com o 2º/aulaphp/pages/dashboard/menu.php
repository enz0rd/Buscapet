    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./serviços/menu.php">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <select class="btn btn-sm btn-outline-secondary dropdown-toggle">
            <option value="day" data-feather="calendar" class="align-text-bottom">Hoje</option>
            <option value="week" data-feather="calendar" class="align-text-bottom">Essa semana</option>
            <option value="month" data-feather="calendar" class="align-text-bottom">Esse mês</option>
          </select>
        </div>
      </div>
