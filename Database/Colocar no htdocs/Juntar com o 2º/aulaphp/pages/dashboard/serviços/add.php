    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="./menu.php">
          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                ...
                <small class="text-muted name" id="output_name">Nome do Serviço</small>
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
          ...
          <form class="needs-validation" novalidate method="POST" action="./src/produto.php" enctype="multipart/form-data">
            <div class="row g-3">
              ...
              <div class="col-4">
                ...
                <div class="input-group has-validation">
                  <select onchange="loadtype()" class="form-select" id="empresa" name="empresa" required>
                    <option value="Nenhuma">Selecione uma opção</option>
                    <?php
                    include_once('../../../conecta.php');
